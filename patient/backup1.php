      ...
      html, body {
       ...
       <a style="text-decoration:none;color:black" class="btn btn-warning btn-md" href="view_map.php" 
          onclick="return confirm('Sure to Move?');"><b><center>
            <font style="font-size:20px;text-decoration:NULL;border-style:solid;">&nbsp;Jaundice: Back To Dashboard&nbsp;</style></font>
          </center></b></a>
          <hr/>
  </head>
  <body>
    ...
    <script>
      ...
      var citymap = {
        Ahmedabad: {
          ...
          population: 557794,name:'20'
        },
        Sarangpur: {
          center: {lat: 22.2587, lng: 71.75},
          population: 840583,name:'55'
        },
        MEHSANA: {
          center: {lat: 23, lng: 72},
          population: 385779,name:'5'
        },
      BARODA: {
          center: {lat: 22, lng: 73.1707},
