                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="signupprocess.php"> 
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="email">Health-Card Number:</label>
                                            <input type="text" class="form-control" id="email" placeholder="Health-Card ID" name="cardid">
                                        </div>
                                        ...
                                        <div class="form-group">
                                              ...
                                              <center>  <button class="btn btn-success" name="submit">Sign In</button></center>
