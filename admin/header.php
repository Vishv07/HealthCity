...
bottom: 0;
    ...
    background: #fff url('assets/gif/loader1.gif')
    no-repeat center;
    z-index: 99999;
}
        ...
        <div class="layout">
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.php">
                        <img src="assets/images/logo/logo1.png" alt="Logo" style="height: 70px; width: 100px;">
                        <img class="logo-fold" src="assets/images/logo/logo1.png" alt="Logo">
                    </a>
                </div>
                    ...
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="gen_card.php">Generate Health-Card</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="bmianalysis.php">BMI Wise</a>
                                </li>
            
                                  <li>
                                    <a href="dianalysis.php">Diseases Wise</a>
                                </li>
                                  <li>
                                    <a href="Yearly.php">Yearly</a>
                                </li>
                                 <li>
                                    <a href="symtom.php">Symotoms Based Diseases</a>
                                </li>
                                 <li>
                                    <a href="area.php">Area Wise </a>
                                </li>
