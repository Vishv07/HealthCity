                       ...
                       <div class="col-lg-12 bg-white">
                            ...
                            <div class="col-lg-12">
                             ...
                             <div class="form-row">
                                     <div class="form-group col-md-2">
                                        ...
                                        <select id="inputState" class="form-control"  name="city" id="state_list" onchange="getCity(this.value);">
                                            <option >All </option>
                                            <?php
                         $con= mysqli_connect('localhost', 'root', '','health_city');
                        ...
                        ?>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="area-list" class="form-control"  name="area">
...
<script type="text/javascript">
 ...
 <?php
                        extract($_POST);
                         ...
                         $sql = "SELECT * FROM city_master where city_id  = $city";
                          $sql1 = "SELECT * FROM area_master where area_id  = $area";
                         $result = mysqli_query($con,$sql);
...
$area =$row1['area_name'];
 ...
 /*   echo $city.$area.$age.$gender;*/
   $command = escapeshellcmd("C:\Users\Krishna\AppData\Local\Programs\Python\Python37\python.exe areaWisePrevailDisease.py ".$area." ".$city." ".$age." ".$gender);
