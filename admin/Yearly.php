                    ...
                    <div class="row bg-white">
                       <div class="col-lg-12 bg-white">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="Yearly.php"  method="post"  enctype="multipart/form-data" >
                             <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select id="inputSsdtate" class="form-control"  name="month">
...
<script type="text/javascript">
  <?php
   ...
   $command = escapeshellcmd("C:\Users\Krishna\AppData\Local\Programs\Python\Python37\python.exe panprac.py ".$year." ".$month." ".$city);
