                    ...
                    <div class="row bg-white">
                       <div class="col-lg-12 bg-white">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="bmianalysis.php"  method="post"  enctype="multipart/form-data" >
                             <div class="form-row">
...
<?php
    ...
    $age = $_POST['age'];
    $gender = $_POST['gender'];
   $command = escapeshellcmd("C:\Users\Krishna\AppData\Local\Programs\Python\Python37\python.exe bmi.py ".$city." ".$age." ".$gender);
