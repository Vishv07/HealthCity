    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/otp.jpg');">
                ...
                <div class="col-lg-7 bg-white">
                    ...
                    ?>
				      ...
				      <div class="row">
				       <div class="col-xs-12">
				          <button type="submit" name="submit" class="btn btn-success btn-tone m-r-5 btn-block b_r_20 m-t-20">Change</button>
				        </div></div>
						<?php
