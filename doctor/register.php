    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/register.jpg');">
                               ...
                               <form class="form-horizontal login_validator" action="insert3.php" method="post" enctype="multipart/form-data" style="margin-top: -20px">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row m-t-25">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="u-name" class="col-form-label">Registration Number*</label>
                                            </div>
                                            <div class="col-xl-9 col-lg-8">
                                                <div class="input-group input-group-prepend">
                                                    <span class="input-group-text border-right-0 rounded-left"> 
                                        ...
                                        <div class="form-group row m-t-25">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="u-name" class="col-form-label">Experience*</label>
                                            </div>
                                            <div class="col-xl-9 col-lg-8">
                                                <div class="input-group input-group-prepend">
                                                    <span class="input-group-text border-right-0 rounded-left"> 
                                                    ...
                                                    <input type="text" name="exp" class="form-control" placeholder="Enter Experience ..." required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row m-t-25">
                                            ...
                                            <div class="col-xl-9 col-lg-8">
                                              <input type="file" id="profile-img" name="image" accept="image/png,image/jpg,image/jpeg" class="form-control" placeholder="" class="btn btn-warning fileinput-exists">
                                                <div id="myDiv" align="center" class="col-xl-9 col-lg-12" style="margin-top:10px;margin-left: 40px"> 
                                                    <!--<p class="square"> -->
                                                  <img src="../assets/images/default.png" id="profile-img-tag" alt="Profile Pic" width="180px" height="200px" style="border:5px solid #ffffff; background-color: #ffffff;" />
