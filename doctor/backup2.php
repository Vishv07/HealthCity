      ...
      html, body {
       ...
       <a style="text-decoration:none;color:black" class="btn btn-warning btn-md" href="view_map.php" 
          onclick="return confirm('Sure to Move?');"><b><center>
            <font style="font-size:20px;text-decoration:NULL;border-style:solid;">&nbsp;SwineFlu: Back To Dashboard&nbsp;</style></font>
          </center></b></a>
          <hr/>
  </head>
  <body>
    ...
    <script>
      ...
      var citymap = {
        Ahmedabad: {
          center: {lat: 23, lng: 72.602},
          population: 557794,name:'50'
        },
        Sarangpur: {
          center: {lat: 22, lng: 71.75},
          population: 840583,name:'15'
        },
        MEHSANA: {
          center: {lat: 23, lng: 72},
          population: 385779,name:'45'
        },
      BARODA: {
          center: {lat: 22, lng: 73},
          population: 603502,name:'85'
        },
        BHUJ: {
            center: {lat:23.0655, lng: 70},
            population: 603502,name:'50'
          },
          DWARKA: {
              center: {lat:22.2442, lng: 68.9685},
              population: 603502,name:'80'
            }
