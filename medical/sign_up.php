    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/medical.jpg');">
                    <div class="d-flex h-100 p-h-40 p-v-15 flex-column justify-content-between">
                        <div style="margin-top: 5%">
                            <h1 class="text-black m-b-20 font-weight-normal"><b>HealthCity</b></h1>
                            <p class="text-black font-size-20  opacity-08" style="color:black; text-shadow: 1px 1px black;"><b>Health City is a web portal and Data Analysis Tool which help to generate health card for every citizen.</b></p>
                        </div>
                    </div>
                </div>
