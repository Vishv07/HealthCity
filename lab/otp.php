    ...
    <div class="app">
        <div class="container-fluid p-0 h-100">
            <div class="row no-gutters h-100 full-height">
                <div class="col-lg-5 d-none d-lg-flex bg" style="background-image:url('../assets/images/lab4.jpg');">
                    <div class="d-flex h-100 p-h-40 p-v-15 flex-column justify-content-between">
                        <div style="margin-top: 25%">
                            <h1 class="text-white m-b-20 font-weight-normal"><b>HealthCity</b></h1>
                            <p class="text-white font-size-20  opacity-08" style="color:black; text-shadow: 1px 1px blue; background-color: black"><b>Health City is a web portal and Data Analysis Tool which help to generate health card for every citizen.</b></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 bg-white">
                    <div class="container h-100">
                        ...
                        if(isset($_GET['flag']))
                        {
                            if($_GET['flag']==1)
                            {
                                echo "<center><font style='color:red; text-align:center;font-size:15px'>OOPS!!   Incorrect OTP.... :(</font></center><br/>";
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        {
           header("location:otp.php?flag=1");
        }
    }
?>  
